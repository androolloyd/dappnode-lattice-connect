...
This package exposes `3000/tcp` for the lattice-connect relay and `1883/tcp` for the MQTT broker.
...
** NOTE: DNS on the Lattice1 sucks, I recommend just using the IP **
